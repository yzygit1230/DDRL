...
class HistMatch(object):
    """Convert ndarrays in sample to Tensors."""
    def __init__(self):
        self.val_avg_img1_hist = self.get_all_image_hist("/mnt/Disk2/liyemei/change_detection/Mei_CDNet/CDData/LEVIR-CD/val/A")
        self.val_avg_img2_hist = self.get_all_image_hist("/mnt/Disk2/liyemei/change_detection/Mei_CDNet/CDData/LEVIR-CD/val/B")
