...
class DGST(nn.Module):
    def __init__(self, input_c: int, output_c: int, stride: int):
        ...
        self.branch2 =Conv(branch_features,branch_features,3,1,g=1)


        self.convffn = ConvFFN(input_c, input_c * 4, output_c, drop_path=0.2)
...
class C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(DGST(self.c, self.c,stride=1 ) for _ in range(n))
